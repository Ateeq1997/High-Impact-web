  ...
  const faqData = [
    {
      ...
      items: [
        ...
        { question: "Tier", answer: "Alpha User" },
      ],
    },
    {
      section: "Purchase History",
      items: [
        { question: "View Purchase", answer: "You have 2 recent land purchases in Green Valley." },
      ],
    },
    {
      section: "Usage Limits",
      items: [
        { question: "Company Lookups", answer: "You have 500 lookups remaining this month." },
      ],
    },
    {
      section: "Resources",
      items: [
        { question: "Terms of Use", answer: "You must comply with our agricultural data policy." },
        { question: "Privacy Policy", answer: "We protect all land data with encryption." },
        { question: "Email Support", answer: "Reach us at support@farmconnect.com" },
      ],
    },
  ];
